...
- **Zpětná vazba**
	- Mechanismus, kdy ==výstup systému ovlivňuje jeho budoucí vstup==. Slouží ke kontrole chyb a následné nápravě (např. automatická aktualizace systému na základě hlášení o chybách).
- **Kybernetická Hrozba** 
	- ==Možnost že bude poškozeno aktivum== a dojde k Bezpečnostnímu incidentu
...
- Dělení
	...
	- **Technická aktiva**: Konkrétní stroje, výrobní linky či datové servery zajišťující chod firmy.### Základní pojmy a hrozby
...
- **Bezpečnostní událost**: 
	- Jakýkoliv ==stav systému, který se odchyluje od normálu a může ohrozit aktiva.==
- **Bezpečnostní incident**: 
	- ==Již vzniklé narušení bezpečnosti aktiva==, které vyžaduje okamžitou reakci.
